# BCFtools Filter Addition to Sarek Pipeline

## Summary

This update adds bcftools filter functionality to the Sarek pipeline to filter annotated VCF files by PASS variants after VEP annotation.
...
The pipeline syntax has been validated and passes `nextflow run . --help` without errors.